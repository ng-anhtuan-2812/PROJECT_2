...
#define PHONE_NUMBER                "+84975723654"
...
#define ACCEL_THRESHOLD 15.0     // Ngưỡng gia tốc đột ngột
...
void updateWebPage() {
    ...
    snprintf(htmlBuffer, sizeof(htmlBuffer), main_page, 
             ...
             String(total_accel, 2).c_str(), String(similarity, 2).c_str(), String(delta_angle, 2).c_str(), 
             matrixHTML.c_str());
